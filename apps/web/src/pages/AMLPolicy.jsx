...
const AMLPolicy = () => {
  return (
    <div className="pt-32 pb-24 min-h-screen">
      <Helmet>
        <title>AML & Compliance Policy | KAPSERFX IT SOLUTIONS EST</title>
      </Helmet>
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="prose prose-invert prose-lg max-w-none space-y-8 text-gray-300">
          ...
          <section>
            ...
            <p>
              Where appropriate, KAPSERFX IT SOLUTIONS EST may request documentation from clients to verify their identity and legitimate business activities before entering into a formal agreement. This documentation may include:
            </p>
          ...
          <section>
            ...
            <p>
              KAPSERFX IT SOLUTIONS EST reserves the right to conduct compliance screening and will refuse to engage with individuals, entities, or jurisdictions subject to international sanctions (such as OFAC, UN, or EU sanctions) or local regulatory restrictions.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              KAPSERFX IT SOLUTIONS EST reserves the absolute right to decline onboarding, suspend services, or terminate existing agreements immediately if requested due diligence documentation is not provided, or if we identify suspicious, unlawful, or unethical activities associated with a client.
            </p>
          </section>
